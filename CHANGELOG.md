...
- **Phase 7.5 — Cosmetic alignment pass** (eight ad hoc rounds on `claude/0.8.0-phase7.5`, summarized in `docs/0.8.0/redesign-plan.md` §Phase 7.5):
  ...
  - **Deferred:** compose "From" picker full rebuild (searchable picker + Favorites + inline Create-new-address + per-address descriptive labels) — too large for an ad hoc pass, tracked for Phase 6.5 / Phase 8+ in the plan's §7.5 "Deferred" note.
