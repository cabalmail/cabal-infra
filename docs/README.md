...
[![Build and Deploy Android Client](https://github.com/cabalmail/cabal-infra/actions/workflows/android.yml/badge.svg)](https://github.com/cabalmail/cabal-infra/actions/workflows/android.yml)
...
Cabalmail is a suite of infrastructure code ([Terraform](https://www.terraform.io/)), containers ([Docker](https://www.docker.com/)), and application code ([React](https://reactjs.org/)) that together create the following system components:
