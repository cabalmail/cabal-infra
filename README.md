...
4. Create a tfvars file to supply appropriate values for the variables above. Consider naming it "terraform.tfvars". An example with documentation is provided in the file "terraform.tfvars.example".
