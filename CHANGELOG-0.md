...
Continued in [CHANGELOG.md](./CHANGELOG.md).
...
### Added
- Apple (iPad/visionOS): a draggable handle now sits between the message list
  and the reading pane, and the width you set is remembered across launches.
